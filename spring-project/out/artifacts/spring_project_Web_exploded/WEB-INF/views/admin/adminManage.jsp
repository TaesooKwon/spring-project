...
<head>
	...
	<link rel="stylesheet" href="../resources/css/admin/adminManage.css">
...
<div class="admin_content_wrap">
	<div class="admin_content_subject"><span>관리자 관리</span></div>
	<div class="author_table_wrap">
		...
		<c:if test="${listCheck != 'empty' }">
			<table class="author_table">
				<thead>
				<tr>
					<td class="th_column_1">관리자 번호</td>
					<td class="th_column_2">관리자 이름</td>
				</tr>
				</thead>
	...
	<div class="search_wrap">
		<form id="searchForm" action="/admin/adminManage" method="get">
	...
	<form id="moveForm" action="/admin/adminManage" method="get">
