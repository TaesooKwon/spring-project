...
<head>
	...
	<link rel="stylesheet" href="../resources/css/admin/adminPop.css">
	<script
	...
	<div class="content_wrap">
		...
		<div class="author_table_wrap">
			...
			<div class="search_wrap">
				<form id="searchForm" action="/admin/adminPop" method="get">
			...
			<form id="moveForm" action="/admin/adminPop" method="get">
