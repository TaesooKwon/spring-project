	...
	<div class="admin_content_main">
		...
		<div class="form_section">
			...
			<div class="form_section_content">
				<input name="product_name" value="<c:out value="${goodsInfo.product_name}"/>" disabled>
			</div>
		</div>
		<div class="form_section">
			<div class="form_section_title">
		...
		<div class="form_section">
			...
			<div class="form_section_content">
				<input name="product_Price" value="<c:out value="${goodsInfo.product_price}"/>" disabled>
			</div>
		</div>
		<div class="form_section">
			<div class="form_section_title">
			...
			<div class="form_section_content">
				<input name="product_Stock" value="<c:out value="${goodsInfo.product_stock}"/>" disabled>
			</div>
		</div>
		<div class="form_section">
			<div class="form_section_title">
		...
		<div class="form_section">
			...
			<div class="form_section_content bit">
				<textarea name="product_Intro" id="Product_Intro_textarea" disabled>${goodsInfo.product_intro}</textarea>
			</div>
		</div>
		<div class="form_section">
			<div class="form_section_title">
...
<script>
	...
	$(document).ready(function(){
		...
		/* 할인율 값 삽입 */
		let product_Discount = '<c:out value="${goodsInfo.product_discount}"/>' * 100;
		$("#discount_interface").attr("value", product_Discount);
		/* 위지윅 적용 */
