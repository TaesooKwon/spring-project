    ...
    <div class="wrap">
        <div class="content_area">
                ...
                <table class="cart_table">
                    ...
                    <c:forEach items="${cartInfo}" var="ci">
                        <tr>
                            ...
                            <td class="td_width_2">
                                <div class="image_wrap" data-bookid="${ci.imageList[0].id}" data-path="${ci.imageList[0].uploadPath}" data-uuid="${ci.imageList[0].uuid}" data-filename="${ci.imageList[0].fileName}">
                                    <img>
                                </div>
                            </td>
                            ...
                            <td class="td_width_4 price_td">
                                <del>정가 :
                                    <fmt:formatNumber value="${ci.product_price}" pattern="#,### 원" /></del><br>
                                판매가 : <span class="red_color">
                                            <fmt:formatNumber value="${ci.salePrice}" pattern="#,### 원" /></span><br>
                                마일리지 : <span class="green_color">
                                            <fmt:formatNumber value="${ci.point}" pattern="#,###" /></span>
                            </td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="totalKind_span"></span>종 <span
                                                class="totalCount_span"></span>개(ea)</td>
                                    </tr>
                                </table>
                            </td>
                            <td>
            ...
            <form action="/cart/update" method="post" class="quantity_update_form">
                ...
                <input type="hidden" name="ProductCount" class="update_bookCount">
            ...
            <!-- 주문 form -->
            <form action="/order/${member}" method="get" class="order_form">
...
<script>
    ...
    $(".quantity_modify_btn").on("click", function () {
        ...
        $(".update_bookCount").val(productCount);
    ...
    $(".order_btn").on("click", function () {
        ...
        $(".cart_info_td").each(function (index, element) {
            ...
            if ($(element).find(".individual_cart_checkbox").is(":checked") === true) { //체크여부
                ...
                let id = $(element).find(".individual_bookId_input").val();
                let productCount = $(element).find(".individual_bookCount_input").val();

                let id_input = "<input name='orders[" + orderNumber +
                    "].id' type='hidden' value='" + id + "'>";
                form_contents += id_input;

                let productCount_input = "<input name='orders[" + orderNumber +
                    "].productCount' type='hidden' value='" + productCount + "'>";
