...
<div class="main">
    ...
    <div class="contents">
        <input type="button" id="event_regi" value="등록">
                ...
                <div class="divTableBody">
                    <div class="divTableRow">
                        ...
                        <div class="divTableCell">
                            <a href="/event/eventDetail/${v.event_id}">${v.event_title}</a>
                        </div>
                        <div class="divTableCell">${v.mod_date}</div>
                        <div class="divTableCell"><input type="button" onclick="event_push(${v.event_id})" value="전송"></div>
                    </div>
                </div>
            </c:forEach>
        </div>
