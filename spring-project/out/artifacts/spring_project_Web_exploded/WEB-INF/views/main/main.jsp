...
<div class="v1_1356">
    ...
    <div class="v1_1583">
        <div class="slide eventpicture active">
            <img src='http://drive.google.com/uc?export=view&id=1gtJdlcM7oDeNBnFx22BcDNLnqzNk-OKj' /><br>
        </div>
    ...
    <div class="v1_1493">
        <span class="v1_1494">디지털/가전</span><span class="v1_1495">생활/건강</span><span class="v1_1496">스포츠/레저</span>
    </div>
    <div class="v1_1502">
        <span class="v1_1503">디지털/가전</span><span class="v1_1504">생활/건강</span><span class="v1_1505">스포츠/레저</span>
    </div>
    <div class="v1_1490">
        <div class="sidebar1">
        ...
        <div class="productlist con">
            <c:if test="${listcheck != 'empty'}">
                <ul class="row">
                    ...
                    <li class="cell_05">
                        <div class="img-box" data-id="${list4.imageList[0].id}" data-path="${list4.imageList[0].uploadPath}" data-uuid="${list4.imageList[0].uuid}" data-filename="${list4.imageList[0].fileName}">
                            <a href="/product/goodsDetail/${list4.id}">
                                <img>
                            </a>
                        </div>
                        <div class="product-name">${list4.product_name}</div>
                        <div class="product-price"><fmt:formatNumber value="${list4.product_price}" pattern="#,###" /></div>
                    </li>
                    </c:forEach>
                    <c:forEach items="${list1}" var="list1">
                        <li class="cell_01">
    ...
    <div class="v1_1549">
        <form id="moreForm" action="/product/category_list">
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        $(".v1_1503").click(function (){
            $(".v1_1503").addClass('active')
            $(".v1_1504").removeClass('active')
            $(".v1_1505").removeClass('active')

            let category_name = "digital/homeapp"
            show_layer(category_name)
        })
        $(".v1_1504").click(function (){
            $(".v1_1503").removeClass('active')
            $(".v1_1504").addClass('active')
            $(".v1_1505").removeClass('active')
        ...
        $(".v1_1505").click(function (){
            $(".v1_1503").removeClass('active')
            $(".v1_1504").removeClass('active')
            $(".v1_1505").addClass('active')

            let category_name = "sports/leisure"
            show_layer(category_name)
        })
        $(".v1_1494").click(function (){
            $(".v1_1494").addClass('active')
            $(".v1_1495").removeClass('active')
            $(".v1_1496").removeClass('active')
            $('.hideValue').val("digital/homeapp")
            let category_name = "digital/homeapp"
            show_layer2(category_name)
        })
        $(".v1_1495").click(function (){
            $(".v1_1494").removeClass('active')
            $(".v1_1495").addClass('active')
            $(".v1_1496").removeClass('active')
        ...
        $('#moreForm').mouseenter(function (){
            $('.v1_1550').css("background-color","black")
            $('.v1_1551').css("color","white")
        })
        $('#moreForm').mouseleave(function (){
            $('.v1_1550').css("background-color","white")
            $('.v1_1551').css("color","black")
        }) //더보기 hover
