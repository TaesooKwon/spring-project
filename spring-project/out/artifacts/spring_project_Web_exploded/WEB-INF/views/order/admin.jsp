        ...
        <div class="member_info_div">
          <table class="table_text_align_center memberInfo_table">
            ...
            <tr>
              ...
              <td style="width: *">${memberInfo.member_name} | ${memberInfo.member_email}</td>
            </tr>
            </tbody>
          </table>
        </div>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input class="address_input" value="${memberInfo.member_name}" type="hidden">
        ...
        <div class="orderGoods_div">
          ...
          <table class="goods_table">
            ...
            <c:forEach items="${orderList}" var="ol">
              <tr>
                <td>
                  <div class="image_wrap" data-id="${ol.imageList[0].id}" data-path="${ol.imageList[0].uploadPath}" data-uuid="${ol.imageList[0].uuid}" data-filename="${ol.imageList[0].fileName}">
                    <img>
                  </div>
                </td>
                <td>${ol.product_name}</td>
                <td class="goods_table_price_td">
                  <fmt:formatNumber value="${ol.salePrice}" pattern="#,### 원" /> | 수량 ${ol.product_count}개
                  ...
                  <input type="hidden" class="individual_bookCount_input" value="${ol.product_count}">
                  <input type="hidden" class="individual_totalPrice_input" value="${ol.salePrice * ol.product_count}">
...
//가격
      ...
      m_redirect_url: 'http://localhost:8083/cart/cart'
      /*
      모바일 결제시,
